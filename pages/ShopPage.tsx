      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div className="space-y-2">
            <h1 className="text-4xl font-black text-[#111813] dark:text-white">Shop Everything</h1>
            <p className="text-gray-500">Find the perfect products for your pets from our curated collection.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {filteredProducts.length > 0 ? (
            ...
            <div className="col-span-full py-20 text-center space-y-4">
              ...
              <p className="text-gray-500 font-medium text-xl">No products found in this category.</p>
              <button onClick={() => setSearchParams({ cat: 'All' })} className="text-primary font-bold underline">Show all products</button>
            </div>
          )}
        </div>
      </div>
